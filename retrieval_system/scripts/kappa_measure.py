...
JUDGEMENT_VECTORS_INPUT_PATH = "./data/05_evaluation/kappa_test/judgement_vectors.csv"
RELEVANCE_STATS_OUTPUT_PATH = "./data/05_evaluation/kappa_test/relevance_stats.csv"

def loadJudgements(path):
    judgements = pd.read_csv(path)
    return judgements
...
if __name__ == "__main__":
    judgements = loadJudgements(JUDGEMENT_VECTORS_INPUT_PATH)
    ...
    f = open(RELEVANCE_STATS_OUTPUT_PATH, "w")
