...
INPUT_DATAFRAME_PATH = "data/processed_data/processed_data.csv"
COMPONENTS_OUTPUT_PATH = "data/model_components/"
...
if __name__ == "__main__":
    generateAllStructures(INPUT_DATAFRAME_PATH, COMPONENTS_OUTPUT_PATH)